...
class ListView
{
    ...
    function GetPageListST($list_len,$listitem="index,end,pre,next,pageno")
    {
        ...
        if($totalpage<=1 && $this->TotalResult>0)
        {
            ...
            return "<a class=\"page\">共 <strong>".$this->TotalResult."</strong>条</a>\r\n";
        }
        ...
        $purl = $this->GetCurUrl();
        $maininfo = "<a class=\"page\">共 <strong>".$this->TotalResult."</strong>条</a>\r\n";
    ...
    function GetPageListDM($list_len,$listitem="index,end,pre,next,pageno")
    {
        ...
        if($totalpage<=1 && $this->TotalResult>0)
        {
            return "<a class=\"page\">共".$this->TotalResult." 条</a>\r\n";
        }
        if($this->TotalResult == 0)
        {
            return "<a class=\"page\">共".$this->TotalResult." 条</a>\r\n";
